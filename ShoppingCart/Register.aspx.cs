...
namespace ShoppingCart
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        {
            if (Session["FbJson"] != null)
            {
                var o = JObject.Parse(Session["FbJson"].ToString());

                this.txtEmail.Text = (o.SelectToken("email") as JValue).Value<string>();
                this.txtUserName.Text = (o.SelectToken("name") as JValue).Value<string>();
            }
        }
